module.exports = {
     ...
     * @optional
     */
    description: "IPInfo Integration for IP Address Reports",
    ...
    block: {
        component: {
            file: "./components/ipinfo-block.js"
        },
        template: {
            file: "./templates/ipinfo-block.hbs"
        }
    },
    summary: {
        component: {
            file: './components/ipinfo-summary.js'
        },
        template: {
            file: './templates/ipinfo-summary.hbs'
        }
    },
    request: {
